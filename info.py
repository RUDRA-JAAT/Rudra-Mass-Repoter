...
class Config(object):
    ...
    OWNER    = int(os.environ.get("OWNER", "6783196044"))  # ⚠️ Required
    SUDO = list(map(int, os.environ.get("SUDO", "6664555866").split()))  # ⚠️ Required
    # Web Response Config
...
☛ For e.g :- <code> @ </code> or <code> https:/t.me/Rudra_jaat_1 </code>
"""
...
Tʜɪs ʙᴏᴛ ɪs sᴏʟᴇʟʏ ᴄʀᴇᴀᴛᴇ ᴏʀ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ :- @Rudra_jaat_1
"""
